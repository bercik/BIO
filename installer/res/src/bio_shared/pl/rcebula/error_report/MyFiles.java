...
public class MyFiles
{
    ...
    public MyFiles(boolean generateFile)
    {
    ...
    public File addFile(String name, int fnum)
    {
        File file = new File(fnum, name);
        files.add(file);
        return file;
    }
    ...
    public static class File
    {
        ...
        private final List<Integer> intFromList = new ArrayList<>();
        ...
        {
            intFromList.add(from);
        }
        
        public void resolveIntFromList(MyFiles files)
        {
            for (int ifl : intFromList)
            {
                addFrom(files.getFromNum(ifl));
            }
        }
